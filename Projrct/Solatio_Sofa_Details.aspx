<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Solatio_Sofa_Details.aspx.cs" Inherits="Solatio_Sofa_Details" %>
...
<div class="product-details-container">
                ...
                <div class="thumbnail-scrollable">
                    <% for(int i = 1; i <= 6; i++) { %>
                        <div class="thumbnail-item">
                            <img src="images/Sofa/Solatio_Sofa/<%=i%>.jpg" alt="Thumbnail <%=i%>" class="thumbnail-image" onclick="changeFeaturedImage('<%=i%>')">
                        </div>
                    <% } %>
                </div>
            </div>
            <div class="main-image">
                <img id="featuredImage" src="images/Sofa/Solatio_Sofa/1.jpg" alt="Barcelona L Shape Sofa Set" class="featured-product-image">
            </div>
        </div>
        <div class="product-info">
            <h1>Solatio Sofa - Three Seater</h1>
            <p class="product-size">Size: <strong>(6'x5') Feet - Dark Blue</strong></p>
            <p>Regular, Three Seater, Dark Blue</p>
            ...
            <p class="price">Price: <span class="current-price">₹11,998</span> <span class="original-price">₹15,300</span> <span class="discount">(22% off)</span></p>
            <p>
            <h2 class="best-price">₹11,998</h2>
    ...
    <script>
        function changeFeaturedImage(index) {
            ...
            featuredImage.src = `images/Sofa/Solatio_Sofa/${index}.jpg`;
        }
