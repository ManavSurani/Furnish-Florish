<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Amoeba_Sofa_Cum_Bed.aspx.cs" Inherits="Amoeba_Sofa_Cum_Bed" %>
...
<div class="product-details-container">
                ...
                <div class="thumbnail-scrollable">
                    <% for(int i = 1; i <= 19; i++) { %>
                        <div class="thumbnail-item">
                            <img src="images/Sofa/Amoeba_Sofa_Cum_Bed/<%=i%>.jpg" alt="Thumbnail <%=i%>" class="thumbnail-image" onclick="changeFeaturedImage('<%=i%>')">
                        </div>
                    <% } %>
                </div>
            </div>
            <div class="main-image">
                <img id="featuredImage" src="images/Sofa/Amoeba_Sofa_Cum_Bed/1.jpg" alt="Barcelona L Shape Sofa Set" class="featured-product-image">
            </div>
        </div>
        <div class="product-info">
            <h1>Amoeba Sofa Cum Bed - Three Seater</h1>
            <p class="product-size">Size: <strong>(6'x5') Feet - Cobalt Blue</strong></p>
            <p>Regular, Three Seater, Cobalt Blue</p>
            ...
            <p class="price">Price: <span class="current-price">₹22,157</span> <span class="original-price">₹30,890</span> <span class="discount">(28% off)</span></p>
            <p>
            <h2 class="best-price">₹22,157</h2>
    ...
    <script>
        function changeFeaturedImage(index) {
            ...
            featuredImage.src = `images/Sofa/Amoeba_Sofa_Cum_Bed/${index}.jpg`;
        }
