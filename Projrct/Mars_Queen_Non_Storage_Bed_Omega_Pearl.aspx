<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Mars_Queen_Non_Storage_Bed_Omega_Pearl.aspx.cs" Inherits="Mars_Queen_Non_Storage_Bed_Omega_Pearl" %>
...
<div class="product-details-container">
                ...
                <div class="thumbnail-scrollable">
                    <% for(int i = 1; i <= 7; i++) { %>
                        <div class="thumbnail-item">
                            <img src="images/Bed/Mars_Queen_Non_Storage_Bed_Omega_Pearl/<%=i%>.jpg" alt="Thumbnail <%=i%>" class="thumbnail-image" onclick="changeFeaturedImage('<%=i%>')">
                        </div>
                    <% } %>
                </div>
            </div>
            <div class="main-image">
                <img id="featuredImage" src="images/Bed/Mars_Queen_Non_Storage_Bed_Omega_Pearl/1.jpg" alt="Featured Flipper Sofa" class="featured-product-image">
            </div>
        </div>
        <div class="product-info">
            <h1>Mars Queen Non Storage Bed Omega Pearl</h1>
            <p class="product-size">Size: <strong> 78" x 60"  Inches | 1.98m x 1.52m</strong></p>
            <p>Queen, Non Storage, With Upholstery, Omega Pearl</p>
            ...
            <p class="price">Price: <span class="current-price">₹16,500</span> <span class="original-price">₹22,000</span> <span class="discount">(25% off)</span></p>
            <p></p>
            <h2 class="best-price">₹16,500</h2>
    ...
    <script>
        function changeFeaturedImage(index) {
            ...
            featuredImage.src = `images/Bed/Mars_Queen_Non_Storage_Bed_Omega_Pearl/${index}.jpg`;
        }
