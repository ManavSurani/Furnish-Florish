<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Napper_Sofa_Details.aspx.cs" Inherits="Napper_Sofa_Details" %>
...
<div class="product-details-container">
                ...
                <div class="thumbnail-scrollable">
                    <% for(int i = 1; i <= 5; i++) { %>
                        <div class="thumbnail-item">
                            <img src="images/Sofa/Napper_Sofa/<%=i%>.jpg" alt="Thumbnail <%=i%>" class="thumbnail-image" onclick="changeFeaturedImage('<%=i%>')">
                        </div>
                    <% } %>
                </div>
            </div>
            <div class="main-image">
                <img id="featuredImage" src="images/Sofa/Napper_Sofa/1.jpg" alt="Barcelona L Shape Sofa Set" class="featured-product-image">
            </div>
        </div>
        <div class="product-info">
            <h1>Napper Sofa - Three Seater</h1>
            ...
            <p class="price">Price: <span class="current-price">₹25,000</span> <span class="original-price">₹29,800</span> <span class="discount">(16% off)</span></p>
            <p>
            <h2 class="best-price">₹25,000</h2>
    ...
    <script>
        function changeFeaturedImage(index) {
            ...
            featuredImage.src = `images/Sofa/Napper_Sofa/${index}.jpg`;
        }
