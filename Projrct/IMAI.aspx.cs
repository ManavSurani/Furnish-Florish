...
public partial class IMAI : System.Web.UI.Page
{
    ...
    protected void btnAddToCart_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string productName = "IMAI 4 Door Wardrobe with two external drawer";
            string imageUrl = "images/Wardrobe/IMAI/1.jpg";
