<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Belize_L_Shape_Sofa_Set.aspx.cs" Inherits="Belize_L_Shape_Sofa_Set" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                ...
                <div class="thumbnail-scrollable">
                    <% for(int i = 1; i <= 12; i++) { %>
                        <div class="thumbnail-item">
                            <img src="images/Sofa/Belize_L_Shape_Sofa_Set/<%=i%>.jpg" alt="Thumbnail <%=i%>" class="thumbnail-image" onclick="changeFeaturedImage('<%=i%>')">
                        </div>
                    <% } %>
                </div>
            </div>
            <div class="main-image">
                <img id="featuredImage" src="images/Sofa/Belize_L_Shape_Sofa_Set/1.jpg" alt="Featured Flipper Sofa" class="featured-product-image">
            </div>
        </div>
        <div class="product-info">
            <h1>Belize L Shape Sofa Set - Three Seater</h1>
            <p class="product-size">Size: <strong>(6'x5') Feet - Omega Blue</strong></p>
            <p>Regular, Three Seater, Omega Blue</p>
            <p class="rating-section">Rating: <span class="rating">4.5</span> <span class="rating">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (2.0K reviews)</p>
            <p class="cart-stat">300+ added to the cart last week</p>
            <p class="price">Price: <span class="current-price">₹32,694</span> <span class="original-price">₹38,500</span> <span class="discount">(15% off)</span></p>
            <p>
            <h2 class="best-price">₹32,694</h2>
    ...
    <script>
        function changeFeaturedImage(index) {
            ...
            featuredImage.src = `images/Sofa/Belize_L_Shape_Sofa_Set/${index}.jpg`;
        }
