<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Barcelona_L_Shape_Sofa_Set.aspx.cs" Inherits="Barcelona_L_Shape_Sofa_Set" %>
...
<div class="product-details-container">
                ...
                <div class="thumbnail-scrollable">
                    <% for(int i = 1; i <= 8; i++) { %>
                        <div class="thumbnail-item">
                            <img src="images/Sofa/Barcelona_L_Shape_Sofa_Set/<%=i%>.jpg" alt="Thumbnail <%=i%>" class="thumbnail-image" onclick="changeFeaturedImage('<%=i%>')">
                        </div>
                    <% } %>
                </div>
            </div>
            <div class="main-image">
                <img id="featuredImage" src="images/Sofa/Barcelona_L_Shape_Sofa_Set/1.jpg" alt="Barcelona L Shape Sofa Set" class="featured-product-image">
            </div>
        </div>
        <div class="product-info">
            <h1>Barcelona L Shape Sofa Set - Three Seater</h1>
            <p class="product-size">Size: <strong>(6'x5') Feet - Smoke Grey</strong></p>
            <p>Regular, Three Seater, Smoke Grey</p>
            <p class="rating-section">Rating: <span class="rating">4.2</span> <span class="rating">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (1.7K reviews)</p>
            <p class="cart-stat">350+ added to the cart last week</p>
            <p class="price">Price: <span class="current-price">₹40,407</span> <span class="original-price">₹45,990</span> <span class="discount">(12% off)</span></p>
            <p></p>
            <h2 class="best-price">₹40,407</h2>
    ...
    <script>
        function changeFeaturedImage(index) {
            ...
            featuredImage.src = `images/Sofa/Barcelona_L_Shape_Sofa_Set/${index}.jpg`;
        }
