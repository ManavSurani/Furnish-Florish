...
public partial class Flipper_Sofa_Details : System.Web.UI.Page
{
    ...
    protected void btnAddToCart_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // Product details
            decimal price = 8999; // Consider moving this to a config file or database
            string productName = "Flipper Sofa Cum Bed - Three Seater";
            string imageUrl = "images/Sofa/Flipper_Sofa_Cum_Bed/3/1.jpg";
