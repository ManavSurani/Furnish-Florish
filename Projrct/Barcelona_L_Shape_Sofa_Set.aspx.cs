...
public partial class Barcelona_L_Shape_Sofa_Set : System.Web.UI.Page
{
    ...
    protected void btnAddToCart_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // Product details
            decimal price = 40407; // Consider moving this to a config file or database
            string productName = "Barcelona L Shape Sofa Set - Three Seater";
            string imageUrl = "images/Sofa/Barcelona_L_Shape_Sofa_Set/1.jpg";
