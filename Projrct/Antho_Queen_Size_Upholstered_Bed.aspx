<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Antho_Queen_Size_Upholstered_Bed.aspx.cs" Inherits="Antho_Queen_Size_Upholstered_Bed" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                ...
                <div class="thumbnail-scrollable">
                    <% for(int i = 1; i <= 14; i++) { %>
                        <div class="thumbnail-item">
                            <img src="images/Bed/Antho_Queen_Size_Upholstered_Bed/<%=i%>.jpg" alt="Thumbnail <%=i%>" class="thumbnail-image" onclick="changeFeaturedImage('<%=i%>')">
                        </div>
                    <% } %>
                </div>
            </div>
            <div class="main-image">
                <img id="featuredImage" src="images/Bed/Antho_Queen_Size_Upholstered_Bed/1.jpg" alt="Featured Flipper Sofa" class="featured-product-image">
            </div>
        </div>
        <div class="product-info">
            <h1>Antho Queen Size  Upholstered Bed</h1>
            <p class="product-size">Size: <strong> 78" x 60"  Inches | 1.98m x 1.52m</strong></p>
            <p>Queen, With Storege, Blue</p>
            ...
            <p class="price">Price: <span class="current-price">₹25,198</span> <span class="original-price">₹33,499</span> <span class="discount">(25% off)</span></p>
            <p></p>
            <h2 class="best-price">₹25,198</h2>
    ...
    <script>
        function changeFeaturedImage(index) {
            ...
            featuredImage.src = `images/Bed/Antho_Queen_Size_Upholstered_Bed/${index}.jpg`;
        }
