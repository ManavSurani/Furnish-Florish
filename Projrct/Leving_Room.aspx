<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Leving_Room.aspx.cs" Inherits="Leving_Room" %>
            ...
            <ItemTemplate>
                <div class="product-card">
                    <a href='<%# Eval("ProductLink") %>'>
                        ...
                        <p>Rating: <span class="rating"><%# Eval("Rating") %></span> <span class="stars"><%# GetStars(Eval("Rating")) %></span> (<%# Eval("ReviewCount") %>K reviews)</p>
