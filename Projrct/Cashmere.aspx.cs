...
public partial class Cashmere : System.Web.UI.Page
{
    ...
    protected void btnAddToCart_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // Product details
            decimal price = 28597; // Consider moving this to a config file or database
            string productName = "Cashmere Plus 4 Door Wardrobe with 4 Shelves, 2 Drawers, Mirror & 2 Hanging Areas";
            string imageUrl = "images/Wardrobe/Cashmere/1.jpg";
