...
public partial class Belize_L_Shape_Sofa_Set : System.Web.UI.Page
{
    ...
    protected void btnAddToCart_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // Product details
            decimal price = 32694; // Consider moving this to a config file or database
            string productName = "Belize L Shape Sofa Set - Three Seater";
            string imageUrl = "images/Sofa/Belize_L_Shape_Sofa_Set/1.jpg";
