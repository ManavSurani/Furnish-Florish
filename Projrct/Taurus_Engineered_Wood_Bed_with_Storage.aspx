<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Taurus_Engineered_Wood_Bed_with_Storage.aspx.cs" Inherits="Taurus_Engineered_Wood_Bed_with_Storage" %>
...
<div class="product-details-container">
                ...
                <div class="thumbnail-scrollable">
                    <% for(int i = 1; i <= 10; i++) { %>
                        <div class="thumbnail-item">
                            <img src="images/Bed/Taurus_Engineered_Wood_Bed_with_Storage/<%=i%>.jpg" alt="Thumbnail <%=i%>" class="thumbnail-image" onclick="changeFeaturedImage('<%=i%>')">
                        </div>
                    <% } %>
                </div>
            </div>
            <div class="main-image">
                <img id="featuredImage" src="images/Bed/Taurus_Engineered_Wood_Bed_with_Storage/1.jpg" alt="Featured Flipper Sofa" class="featured-product-image">
            </div>
        </div>
        <div class="product-info">
            <h1>Taurus Engineered Wood Bed with Storage</h1>
            <p class="product-size">Size: <strong> 78" x 72"  Inches | 1.98m x 1.82m</strong></p>
            <p>King, Storage, Columbian Walnut, Without Upholstery</p>
            ...
            <p class="price">Price: <span class="current-price">₹13,499</span> <span class="original-price">₹15,291</span> <span class="discount">(12% off)</span></p>
            <p></p>
            <h2 class="best-price">₹13,499</h2>
    ...
    <script>
        function changeFeaturedImage(index) {
            ...
            featuredImage.src = `images/Bed/Taurus_Engineered_Wood_Bed_with_Storage/${index}.jpg`;
        }
