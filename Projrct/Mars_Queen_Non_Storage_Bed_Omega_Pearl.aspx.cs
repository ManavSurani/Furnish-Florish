...
public partial class Mars_Queen_Non_Storage_Bed_Omega_Pearl : System.Web.UI.Page
{
    ...
    protected void btnAddToCart_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // Product details
            decimal price = 16500; // Consider moving this to a config file or database
            string productName = "Mars Queen Non Storage Bed Omega Pearl";
            string imageUrl = "images/Bed/Mars_Queen_Non_Storage_Bed_Omega_Pearl/1.jpg";
