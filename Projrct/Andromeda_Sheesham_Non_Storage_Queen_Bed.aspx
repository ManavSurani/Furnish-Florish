<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Andromeda_Sheesham_Non_Storage_Queen_Bed.aspx.cs" Inherits="Andromeda_Sheesham_Non_Storage_Queen_Bed" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                ...
                <div class="thumbnail-scrollable">
                    <% for(int i = 1; i <= 6; i++) { %>
                        <div class="thumbnail-item">
                            <img src="images/Bed/Andromeda_Sheesham_Non_Storage_Queen_Bed/<%=i%>.jpg" alt="Thumbnail <%=i%>" class="thumbnail-image" onclick="changeFeaturedImage('<%=i%>')">
                        </div>
                    <% } %>
                </div>
            </div>
            <div class="main-image">
                <img id="featuredImage" src="images/Bed/Andromeda_Sheesham_Non_Storage_Queen_Bed/1.jpg" alt="Featured Flipper Sofa" class="featured-product-image">
            </div>
        </div>
        <div class="product-info">
            <h1>Andromeda Sheesham Non Storage Queen Bed</h1>
            <p class="product-size">Size: <strong> 78" x 60"  Inches | 1.98m x 1.52m</strong></p>
            <p>Queen, Without Storege, Sheesham wood, Amber Brown</p>
            ...
            <p class="price">Price: <span class="current-price">₹19,343</span> <span class="original-price">₹20,799</span> <span class="discount">(21% off)</span></p>
            <p></p>
            <h2 class="best-price">₹19,343</h2>
    ...
    <script>
        function changeFeaturedImage(index) {
            ...
            featuredImage.src = `images/Bed/Andromeda_Sheesham_Non_Storage_Queen_Bed/${index}.jpg`;
        }
