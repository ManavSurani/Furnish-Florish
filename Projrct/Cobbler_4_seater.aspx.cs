...
public partial class Cobbler_4_seater : System.Web.UI.Page
{
    ...
    protected void btnAddToCart_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // Product details
            decimal price = 21199; // Consider moving this to a config file or database
            string productName = "Cobbler 4 seater solid wood dining set";
            string imageUrl = "images/Dining/Cobbler_4_seater/1.jpg";
