<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Flipper_Sofa_Details.aspx.cs" Inherits="Flipper_Sofa_Details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                ...
                <div class="thumbnail-scrollable">
                    <% for(int i = 1; i <= 12; i++) { %>
                        <div class="thumbnail-item">
                            <img src="images/Sofa/Flipper_Sofa_Cum_Bed/3/<%=i%>.jpg" alt="Thumbnail <%=i%>" class="thumbnail-image" onclick="changeFeaturedImage('<%=i%>')">
                        </div>
                    <% } %>
                </div>
            </div>
            <div class="main-image">
                <img id="featuredImage" src="images/Sofa/Flipper_Sofa_Cum_Bed/3/1.jpg" alt="Featured Flipper Sofa" class="featured-product-image">
            </div>
        </div>
        <div class="product-info">
            <h1>Flipper Sofa Cum Bed - Three Seater</h1>
            <p class="product-size">Size: <strong>(6'x5') Feet - WarpKnit Grey</strong></p>
            <p>Regular, Three Seater, Warpknit Grey</p>
            ...
            <p class="price">Price: <span class="current-price">₹8,999</span> <span class="original-price">₹12,999</span> <span class="discount">(31% off)</span></p>
            <p></p>
            <h2 class="best-price">₹8,999</h2>
    ...
    <script>
        function changeFeaturedImage(index) {
            ...
            featuredImage.src = `images/Sofa/Flipper_Sofa_Cum_Bed/3/${index}.jpg`;
        }
