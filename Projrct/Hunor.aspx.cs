...
public partial class Hunor : System.Web.UI.Page
{
    ...
    protected void btnAddToCart_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // Product details
            decimal price = 6999; // Consider moving this to a config file or database
            string productName = "Hunor 1 Door Wardrobe";
            string imageUrl = "images/Wardrobe/Hunor/1.jpg";
