...
public partial class Lanta_Queen_Size_Upholstered_Bed : System.Web.UI.Page
{
    ...
    protected void btnAddToCart_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // Product details
            decimal price = 41999; // Consider moving this to a config file or database
            string productName = "Lanta Queen Size Upholstered Bed";
            string imageUrl = "images/Bed/Lanta_Queen_Size_Upholstered_Bed/1.jpg";
