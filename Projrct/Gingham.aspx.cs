...
public partial class Gingham : System.Web.UI.Page
{
    ...
    protected void btnAddToCart_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // Product details
            decimal price = 19999; // Consider moving this to a config file or database
            string productName = "Gingham 4 Door Wardrobe with Drawer, Mirror and 1 Hanging Space (Frosty White)";
            string imageUrl = "images/Wardrobe/Gingham/1.jpg";
