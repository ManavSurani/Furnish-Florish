...
public partial class Solatio_Sofa_Details : System.Web.UI.Page
{
    ...
    protected void btnAddToCart_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // Product details
            decimal price = 11998; // Consider moving this to a config file or database
            string productName = "Solatio Sofa - Three Seater";
            string imageUrl = "images/Sofa/Solatio_Sofa/1.jpg";
