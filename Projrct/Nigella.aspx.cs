...
public partial class Nigella : System.Web.UI.Page
{
    ...
    protected void btnAddToCart_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // Product details
            decimal price = 42119; // Consider moving this to a config file or database
            string productName = "Nigella 4 Seater Dining Set - Mocha Brown";
            string imageUrl = "images/Dining/Nigella/1.jpg";
