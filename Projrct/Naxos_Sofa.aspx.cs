...
public partial class Naxos_Sofa : System.Web.UI.Page
{
    ...
    protected void btnAddToCart_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // Product details
            decimal price = 45499; // Consider moving this to a config file or database
            string productName = "Naxos Sofa - Three Seater";
            string imageUrl = "images/Sofa/Naxos_Sofa/1.jpg";
