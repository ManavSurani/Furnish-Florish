<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Solomon_Sofa_Details.aspx.cs" Inherits="Solomon_Sofa_Details" %>
...
<div class="product-details-container">
                ...
                <div class="thumbnail-scrollable">
                    <% for(int i = 1; i <= 6; i++) { %>
                        <div class="thumbnail-item">
                            <img src="images/Sofa/Solomon_Sofa/<%=i%>.jpg" alt="Thumbnail <%=i%>" class="thumbnail-image" onclick="changeFeaturedImage('<%=i%>')">
                        </div>
                    <% } %>
                </div>
            </div>
            <div class="main-image">
                <img id="featuredImage" src="images/Sofa/Solomon_Sofa/1.jpg" alt="Barcelona L Shape Sofa Set" class="featured-product-image">
            </div>
        </div>
        <div class="product-info">
            <h1>Solomon Sofa - Three Seater</h1>
            <p class="product-size">Size: <strong>(6'x5') Feet - Beige</strong></p>
            <p>Regular, Three Seater, Beige</p>
            ...
            <p class="price">Price: <span class="current-price">₹32,999</span> <span class="original-price">₹50,768</span> <span class="discount">(35% off)</span></p>
            <p>
            <h2 class="best-price">₹32,999</h2>
    ...
    <script>
        function changeFeaturedImage(index) {
            ...
            featuredImage.src = `images/Sofa/Solomon_Sofa/${index}.jpg`;
        }
