...
public partial class Minto : System.Web.UI.Page
{
    ...
    protected void btnAddToCart_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // Product details
            decimal price = 28500; // Consider moving this to a config file or database
            string productName = "Minto sheesham wood Dining Set";
            string imageUrl = "images/Dining/Minto/1.jpg";
