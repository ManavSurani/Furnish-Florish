<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Hunor.aspx.cs" Inherits="Hunor" %>
...
<div class="product-details-container">
                ...
                <div class="thumbnail-scrollable">
                    <% for(int i = 1; i <= 6; i++) { %>
                        <div class="thumbnail-item">
                            <img src="images/Wardrobe/Hunor/<%=i%>.jpg" alt="Thumbnail <%=i%>" class="thumbnail-image" onclick="changeFeaturedImage('<%=i%>')">
                        </div>
                    <% } %>
                </div>
            </div>
            <div class="main-image">
                <img id="featuredImage" src="images/Wardrobe/Hunor/1.jpg" alt="Featured Flipper Sofa" class="featured-product-image">
            </div>
        </div>
        <div class="product-info">
            <h1>Hunor 1 Door Wardrobe</h1>
            ...
            <p class="price">Price: <span class="current-price">₹6,999</span> <span class="original-price">₹10,998</span> <span class="discount">(36% off)</span></p>
            <p></p>
            <h2 class="best-price">₹6,999</h2>
    ...
    <script>
        function changeFeaturedImage(index) {
            ...
            featuredImage.src = `images/Wardrobe/Hunor/${index}.jpg`;
        }
