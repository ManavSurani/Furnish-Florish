<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Naxos_Sofa.aspx.cs" Inherits="Naxos_Sofa" %>
...
<div class="product-details-container">
                ...
                <div class="thumbnail-scrollable">
                    <% for(int i = 1; i <= 5; i++) { %>
                        <div class="thumbnail-item">
                            <img src="images/Sofa/Naxos_Sofa/<%=i%>.jpg" alt="Thumbnail <%=i%>" class="thumbnail-image" onclick="changeFeaturedImage('<%=i%>')">
                        </div>
                    <% } %>
                </div>
            </div>
            <div class="main-image">
                <img id="featuredImage" src="images/Sofa/Naxos_Sofa/1.jpg" alt="Barcelona L Shape Sofa Set" class="featured-product-image">
            </div>
        </div>
        <div class="product-info">
            <h1>Naxos Sofa - Three Seater</h1>
            <p class="product-size">Size: <strong>(6'x5') Feet - Green</strong></p>
            <p>Regular, Three Seater, Green</p>
            ...
            <p class="price">Price: <span class="current-price">₹45,499</span> <span class="original-price">₹69,998</span> <span class="discount">(35% off)</span></p>
            <p>
            <h2 class="best-price">₹45,499</h2>
    ...
    <script>
        function changeFeaturedImage(index) {
            ...
            featuredImage.src = `images/Sofa/Naxos_Sofa/${index}.jpg`;
        }
