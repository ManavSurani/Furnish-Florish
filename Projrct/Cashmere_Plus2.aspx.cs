...
public partial class Cashmere_Plus2 : System.Web.UI.Page
{
    ...
    protected void btnAddToCart_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // Product details
            decimal price = 15898; // Consider moving this to a config file or database
            string productName = "Cashmere Plus 2 Door";
            string imageUrl = "images/Wardrobe/Cashmere_Plus2/1.jpg";
