...
public partial class Venus_Engineered_Wood_Queen_Size_Non_Storage_Bed : System.Web.UI.Page
{
    ...
    protected void btnAddToCart_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // Product details
            decimal price = 17498; // Consider moving this to a config file or database
            string productName = "Venus Engineered Wood Queen Size Non-Storage Bed";
            string imageUrl = "images/Bed/Venus_Engineered_Wood_Queen_Size_Non_Storage_Bed/1.jpg";
