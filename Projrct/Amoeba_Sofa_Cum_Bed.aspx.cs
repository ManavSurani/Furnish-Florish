...
public partial class Amoeba_Sofa_Cum_Bed : System.Web.UI.Page
{
    ...
    protected void btnAddToCart_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // Product details
            decimal price = 22157; // Consider moving this to a config file or database
            string productName = "Amoeba Sofa Cum Bed - Three Seater";
            string imageUrl = "images/Sofa/Amoeba_Sofa_Cum_Bed/1.jpg";
