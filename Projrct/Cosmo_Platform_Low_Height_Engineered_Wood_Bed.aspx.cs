...
public partial class Cosmo_Platform_Low_Height_Engineered_Wood_Bed : System.Web.UI.Page
{
    ...
    protected void btnAddToCart_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // Product details
            decimal price = 9499; // Consider moving this to a config file or database
            string productName = "Cosmo Platform Low Height Engineered Wood Bed";
            string imageUrl = "images/Bed/Cosmo_Platform_Low_Height_Engineered_Wood_Bed/1.jpg";
