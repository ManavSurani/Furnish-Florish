...
public partial class Napper_Sofa_Details : System.Web.UI.Page
{
    ...
    protected void btnAddToCart_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // Product details
            decimal price = 25000; // Consider moving this to a config file or database
            string productName = "Napper Sofa - Three Seater";
            string imageUrl = "images/Sofa/Napper_Sofa/1.jpg";
