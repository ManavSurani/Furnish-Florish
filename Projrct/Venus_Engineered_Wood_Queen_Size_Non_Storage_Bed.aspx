<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Venus_Engineered_Wood_Queen_Size_Non_Storage_Bed.aspx.cs" Inherits="Venus_Engineered_Wood_Queen_Size_Non_Storage_Bed" %>
...
<div class="product-details-container">
                ...
                <div class="thumbnail-scrollable">
                    <% for(int i = 1; i <= 9; i++) { %>
                        <div class="thumbnail-item">
                            <img src="images/Bed/Venus_Engineered_Wood_Queen_Size_Non_Storage_Bed/<%=i%>.jpg" alt="Thumbnail <%=i%>" class="thumbnail-image" onclick="changeFeaturedImage('<%=i%>')">
                        </div>
                    <% } %>
                </div>
            </div>
            <div class="main-image">
                <img id="featuredImage" src="images/Bed/Venus_Engineered_Wood_Queen_Size_Non_Storage_Bed/1.jpg" alt="Featured Flipper Sofa" class="featured-product-image">
            </div>
        </div>
        <div class="product-info">
            <h1>Venus Engineered Wood Queen Size Non-Storage Bed</h1>
            <p class="product-size">Size: <strong> 78" x 60"  Inches | 1.98m x 1.52m</strong></p>
            <p>Queen, Non Storege, Wooden</p>
            ...
            <p class="price">Price: <span class="current-price">₹17,498</span> <span class="original-price">₹23,300</span> <span class="discount">(25% off)</span></p>
            <p></p>
    ...
    <script>
        function changeFeaturedImage(index) {
            ...
            featuredImage.src = `images/Bed/Venus_Engineered_Wood_Queen_Size_Non_Storage_Bed/${index}.jpg`;
        }
