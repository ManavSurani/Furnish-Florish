...
public partial class Simsim : System.Web.UI.Page
{
    ...
    protected void btnAddToCart_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // Product details
            decimal price = 27300; // Consider moving this to a config file or database
            string productName = "Simsim-Ginamon Natural Sheesham Wood Dining Set";
            string imageUrl = "images/Dining/Simsim/1.jpg";
