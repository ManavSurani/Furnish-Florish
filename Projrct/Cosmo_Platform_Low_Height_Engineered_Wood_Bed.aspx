<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Cosmo_Platform_Low_Height_Engineered_Wood_Bed.aspx.cs" Inherits="Cosmo_Platform_Low_Height_Engineered_Wood_Bed" %>
...
<div class="product-details-container">
                ...
                <div class="thumbnail-scrollable">
                    <% for(int i = 1; i <= 7; i++) { %>
                        <div class="thumbnail-item">
                            <img src="images/Bed/Cosmo_Platform_Low_Height_Engineered_Wood_Bed/<%=i%>.jpg" alt="Thumbnail <%=i%>" class="thumbnail-image" onclick="changeFeaturedImage('<%=i%>')">
                        </div>
                    <% } %>
                </div>
            </div>
            <div class="main-image">
                <img id="featuredImage" src="images/Bed/Cosmo_Platform_Low_Height_Engineered_Wood_Bed/1.jpg" alt="Featured Flipper Sofa" class="featured-product-image">
            </div>
        </div>
        <div class="product-info">
            <h1>Cosmo Platform Low Height Engineered Wood Bed</h1>
            <p class="product-size">Size: <strong> 78" x 60"  Inches | 1.98m x 1.52m</strong></p>
            <p>Queen, Without Storege, Columbian Walnut</p>
            ...
            <p class="price">Price: <span class="current-price">₹9,499</span> <span class="original-price">₹11,989</span> <span class="discount">(21% off)</span></p>
            <p></p>
            <h2 class="best-price">₹9,499</h2>
    ...
    <script>
        function changeFeaturedImage(index) {
            ...
            featuredImage.src = `images/Bed/Cosmo_Platform_Low_Height_Engineered_Wood_Bed/${index}.jpg`;
        }
