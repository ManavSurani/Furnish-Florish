...
public partial class Rosemary : System.Web.UI.Page
{
    ...
    protected void btnAddToCart_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // Product details
            decimal price = 16386; // Consider moving this to a config file or database
            string productName = "Rosemary 4 Seater Glass & Metal Dining Set";
            string imageUrl = "images/Dining/Rosemary/1.jpg";
