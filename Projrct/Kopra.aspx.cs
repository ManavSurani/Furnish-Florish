...
public partial class Kopra : System.Web.UI.Page
{
    ...
    protected void btnAddToCart_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // Product details
            decimal price = 37100; // Consider moving this to a config file or database
            string productName = "Kopra 6 seater Dining Set";
            string imageUrl = "images/Dining/Kopra/1.jpg";
