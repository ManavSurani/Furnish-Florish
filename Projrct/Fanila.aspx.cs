...
public partial class Fanila : System.Web.UI.Page
{
    ...
    protected void btnAddToCart_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // Product details
            decimal price = 32900; // Consider moving this to a config file or database
            string productName = "Fanila sheesham wood dining set with four chairs";
            string imageUrl = "images/Dining/Fanila/1.jpg";
