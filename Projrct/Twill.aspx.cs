...
public partial class Twill : System.Web.UI.Page
{
    ...
    protected void btnAddToCart_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // Product details
            decimal price = 8299; // Consider moving this to a config file or database
            string productName = "Twill 2 Door Compact Wardrobe (Frosty White)";
            string imageUrl = "images/Wardrobe/Twill/1.jpg";
